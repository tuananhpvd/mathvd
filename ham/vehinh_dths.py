...
from ham.vh_dths.vh_dths_b3 import *


class vh_dths_b3_Dialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        loadUi("ui/dothi_hamso_dialog.ui", self)
        ...
        self.btn_vedt.clicked.connect(self.thuchien)
