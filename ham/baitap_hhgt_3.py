...
from ham.bt_hhgt_3.bt_hhgt_3_ptmp import *
from ham.bt_hhgt_3.bt_hhgt_3_ptdt import *


class bt_hhgt_3_ptmp_Dialog(QDialog):
    ...
    def thuchien(self):
        ...
        if chon == -1:
            ...
            bt_hhgt_3_ptmp.ptmp_1(self)


class bt_hhgt_3_ptdt_Dialog(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        loadUi("ui/baitap_dialog.ui", self)
